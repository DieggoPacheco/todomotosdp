<?php 
	...
	class UsuariosModel extends Mysql
	{
		...
		public function selectUsuario(int $idpersona){
			...
			$sql = "SELECT p.idpersona,p.identificacion,p.nombres,p.apellidos,p.telefono,p.email_user,p.nit,p.nombrefiscal,p.direccionfiscal,r.idrol,r.nombrerol,p.status, to_char(p.datecreated, 'dd-mm-yyyy') as fecharegistro
					FROM persona p
					INNER JOIN rol r
					ON p.rolid = r.idrol
