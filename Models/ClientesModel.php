...
class ClientesModel extends Mysql
{
	...
	public function selectCliente(int $idpersona){
		...
		$sql = "SELECT idpersona,identificacion,nombres,apellidos,telefono,email_user,nit,nombrefiscal,direccionfiscal,status, to_char(datecreated, 'dd-mm-yyyy') as fecharegistro 
				FROM persona
