<?php 
	...
	class Roles extends Controllers{
		...
		public function Roles()
		{
			...
			$data['page_title'] = "Roles Usuario <small> Todo Motos DP</small>";
		...
		public function getRoles()
		{
			if($_SESSION['permisosMod']['r']){
				...
				for ($i=0; $i < count($arrData); $i++) {
					...
					{
						$arrData[$i]['status'] = '<span class="btn btn-warning">Activo</span>';
					}else{
						$arrData[$i]['status'] = '<span class="btn btn-danger">Inactivo</span>';
					}
